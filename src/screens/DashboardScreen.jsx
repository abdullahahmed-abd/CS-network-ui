...
const STYLES = `
  ...
  .sidebar{
    ...
    gap:28px; height:100vh; overflow-y:auto; overflow-x:hidden;
  ...
  .brand-text{
    ...
    font-size:17px; line-height:1.1; color:var(--sage-deeper);
  }
  .brand-sub{
  ...
  .nav-item.active{
    background:var(--sage-tint); color:var(--sage-deeper);
  ...
  /* ── Main ── */
  .main{
    padding:28px 36px 48px; min-width:0;
    height:100vh; overflow-y:auto; overflow-x:hidden;
    scrollbar-width:thin; scrollbar-color:var(--sage-mid) transparent;
  }
  .main::-webkit-scrollbar{ width:6px; }
  .main::-webkit-scrollbar-track{ background:transparent; }
  .main::-webkit-scrollbar-thumb{ background:var(--sage-mid); border-radius:6px; }
  .main::-webkit-scrollbar-thumb:hover{ background:var(--sage); }

  .topbar{
    display:flex; align-items:center; justify-content:space-between;
    gap:18px; margin-bottom:26px; position:sticky; top:0;
    background:rgba(255,255,255,0.95); backdrop-filter:blur(12px);
    -webkit-backdrop-filter:blur(12px); z-index:20;
  ...
  .icon-btn{
    ...
    color:var(--sage-deeper); cursor:pointer;
  ...
  .kpi-card::before{
    ...
    bottom:0; width:4px; background:var(--sage);
  }
  .kpi-icon{
  ...
  .chain-node{
    ...
    gap:8px; min-width:100px; text-align:center; flex-shrink:0;
  }
  .chain-avatar{
    width:46px; height:46px; border-radius:50%;
    background:var(--sage-tint); border:2px solid var(--sage);
    color:var(--sage-deeper); display:flex; align-items:center;
  ...
  .chain-link{
    ...
    gap:4px; position:relative; top:-18px; min-width:60px;
  }
  .chain-link .line{
  ...
  thead th{
    ...
    padding:0 8px 10px; border-bottom:1px solid var(--line); white-space:nowrap;
  }
  tbody td{
  ...
  .upcoming-kind{
    ...
    letter-spacing:.04em; color:var(--sage-dark); background:var(--sage-tint);
    padding:3px 8px; border-radius:6px; flex-shrink:0; margin-top:2px; white-space:nowrap;
  }
  ...
  /* ── Bottom grid ── */
  .grid-bottom{ display:grid; grid-template-columns:1fr 1.2fr; gap:18px; }
  .partner-row{
  ...
  .scroll-top-btn{
    ...
    align-items:center; justify-content:center;
    box-shadow:0 4px 16px rgba(62,86,49,0.25); z-index:50;
  ...
  @media (max-width:720px){
    ...
    .sidebar{
      ...
      background:rgba(255,255,255,0.97); backdrop-filter:blur(12px); padding:12px 14px;
    }
      ...
      >
        ...
        <div className="topbar">
          ...
          <div className="topbar-right">
            ...
            <div className="foot-avatar" style={{ width: 36, height: 36 }}>
              AB
            </div>
          </div>
        </div>
          ...
          <div className="panel">
            <div className="panel-head">
              ...
              <div className="panel-link">
                Open deal engine <ChevronRight size={13} />
              </div>
            </div>
            <ResponsiveContainer width="100%" height={220}>
              <BarChart data={pipeline} margin={{ left: -18, right: 8 }}>
                ...
                <XAxis
                  dataKey="stage"
                  tick={{ fontSize: 11, fill: "#75806E" }}
                  axisLine={{ stroke: "#E5EBDF" }}
                  tickLine={false}
                />
                <YAxis
                  tick={{ fontSize: 11, fill: "#75806E" }}
                ...
                />
                <Tooltip
                  contentStyle={{ borderRadius: 10, border: "1px solid #E5EBDF", fontSize: 12 }}
                  cursor={{ fill: "#EEF5E8" }}
                />
        ...
        <div className="panel" style={{ marginBottom: 18 }}>
          <div className="panel-head">
            ...
            <div className="panel-link">
              All referral chains <ChevronRight size={13} />
            </div>
          </div>
          <div className="chain">
            ...
            <div className="chain-node">
              <div
                ...
                style={{ background: "#3E5631", color: "#fff", borderColor: "#3E5631" }}
              >
                <Handshake size={18} />
              </div>
          ...
          <div className="chain-note">
            Each introducer's share is locked at handshake and feeds the commission
            ledger automatically — no manual splitting once the deal closes.
          </div>
        </div>
        ...
        <div className="grid-bottom">
          ...
          <div className="panel">
            <div className="panel-head">
              ...
              <div className="panel-link">
                CSI rankings <ChevronRight size={13} />
              </div>
            </div>
            {partners.map((p) => (
